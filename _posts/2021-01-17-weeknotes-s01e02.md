...
![Screenshot of a Slack thread in the #govuk-replatforming channel. Richard Towers says "I had an absolutely galaxy brain idea last night for the terraform app deployments. It's going to change our lives." followed by "Don't want to oversell it, but it's the best idea that's ever been thought up." and a thinking emoji.](/static/images/big-brain.png)
